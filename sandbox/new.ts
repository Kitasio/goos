export const data = [
    ...
    },
    {
        ...
        images: [
            ...
            "/images/projects/BAIKAL1/3.jpg",
            "/images/projects/BAIKAL1/4.jpg",
            "/images/projects/BAIKAL1/5.jpg"
        ]
    },
    {
        title: "SPIN4SPIN",
    ...
    {
        title: "VLADIMIR VARNAVA X HIPO PLATFORM",
        tagNames: [
            "#фото",
            "#эдиториал",
            "#женскийстайлинг"
    ...
    {
        title: "DAVAI BROSAT X SOCIAL VIDEO",
        tagNames: [
            "#видео",
            "#реклама",
            "#женскийстайлинг",
    ...
    {
        title: "YANDEX MONEY x Martirosyan & Beburishvili ",
        tagNames: [
            "#видео",
            "#реклама",
            "#мужскойстайлинг",
    ...
    },
    {
        ...
        images: [
            "/images/projects/MANIQU.RU/2.JPG",
            "/images/projects/MANIQU.RU/1.JPG"
        ]
    },
    {
        title: "SAMOLET",
    ...
    {
        title: "BLINDING x KALTBLUT MAGAZINE",
        tagNames: [
            "#фото",
            "#эдиториал",
            "#женскийстайлинг",
    ...
    {
        title: "THE PROVEN POINT X SOLSTICE MAGAZINE",
        tagNames: [
            "#фото",
            "#эдиториал",
            "#женскийстайлинг",
    ...
    {
        title: "ХОЛОСТЯК 6 сезон - ЕГОР КРИД ",
        tagNames: [
            "#видео",
            "#реклама",
            "#музыкальныйклип",
