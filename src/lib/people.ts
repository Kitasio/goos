export const people = [
	{
		...
		link: '/team/gooseva',
		profession: `Креативный директор, стилист,
		художник по костюмам. 
		Основатель проекта <a href="https://www.instagram.com/gooseva_komanda">@gooseva_komanda.</a>`,
...
Стилист съемок для MANIZHA, L&rsquo;ONE, ELKA, ZVENTA SVENTANA, Анны Хилькевич, Бурито, Sunsay, Dr.Krivorotov , группы Фрукты, Полины Максимовой, Егора Корешкова, Дениса Шведова, Сати Казановой и&nbsp;др.
	...
	},
	{
		...
		about: `Ира может удовлетворить запрос даже на&nbsp;самые сложные и&nbsp;уникальные образы. За&nbsp;год она успела, как ассистент художника по&nbsp;костюму, поработать в&nbsp;различных проектах, разноплановых как по&nbsp;сложности и&nbsp;составу участников, так и&nbsp;по&nbsp;художественной линии: в&nbsp;рекламе, клипах, фотопроектах, на&nbsp;крупных музыкальных фестивалях, собирая образы для артистов для выхода на&nbsp;красную дорожку. Ира обладает прекрасным чувством стиля, которое постоянно развивает, активно изучая живопись, кинематограф, архитектуру, историю моды и&nbsp;костюма, и&nbsp;конечно, современные тренды и&nbsp;тенденции.`,
	...
	},
	{
		...
		projects: ['artificial', 'blooming', 'connect', 'forest', 'gressus', 'lost', 'olga', 'philip', 'hyundai']
	},
	{
		...
		projects: ['fak', 'fashion', 'gogen', 'hasky', 'ingrad', 'sabato', 'maison', 'meduza', 'shijeco', 'guise', 'tsym', 'butler']
	},
	{
		text: 'Вера Гаврилова',
